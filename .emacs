...
;;(define-key global-map "\M-p" 'auto-complete)
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:stipple nil :background "#000000" :foreground "#ffffff" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 120 :width normal :foundry "outline" :family "Consolas"))))
 ...
 '(font-lock-constant-face ((t (:foreground "slate gray" :weight bold))))
 '(font-lock-function-name-face ((t (:foreground "thistle2"))))
 '(font-lock-keyword-face ((t (:foreground "light slate gray" :weight bold))))
 '(font-lock-negation-char-face ((t (:weight bold))))
 '(font-lock-preprocessor-face ((t (:inherit default))))
 '(font-lock-string-face ((nil (:foreground "#bada55"))))
 '(font-lock-type-face ((t (:foreground "light gray" :weight semi-light))))
 '(font-lock-variable-name-face ((t (:foreground "light slate blue"))))
